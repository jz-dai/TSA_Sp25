...
ggplot(inflow_data_yearly, aes = (x=inflow_data_yearly$my_year, y=inflow_data_yearly$inflow_data)) +
  geom_line()+
  geom_smooth()
```
...
cor.test(inflow_data_yearly$inflow_data, my_year, method = "spearman")
```
