...
# acf value not plotted because 12 months is not enough to calculate it
...
```{r}
electric_ts <- ts(electricity_price_processed$All.sectors, start = c(2001,1), frequency = 12)

autoplot(SARIMA_for) +
  autolayer(electric_ts, series = "actual")
