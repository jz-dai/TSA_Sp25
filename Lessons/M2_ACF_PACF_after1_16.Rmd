...
ggplot(inflow_data, aes(x=my_date, y= HP1), color = "blue") + 
  geom_line(aes(y = HP2), color = "red") +
  geom_line(aes(y = HP3), color = "green") + 
...
HP1_acf=acf(ts_inflow_data[,2], lag = 120)
# the up and down movements represent the seasonality
HP1_pacf=
