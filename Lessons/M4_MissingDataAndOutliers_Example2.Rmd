...
```{r}
clean_na_wind_data_1 <- na.interp(ts_wind_data)
autoplot(clean_na_wind_data_1, series = "NA dropped")+
  autolayer(ts_wind_data, series = "Original")+
  ylab("Average Wind Speed") 
```
...
```{r}
clean_na_wind_data <- na.approx(ts_wind_data)
autoplot(clean_na_wind_data, series = "NA dropped")+
  autolayer(ts_wind_data, series = "Original")+
  ylab("Average Wind Speed") 
